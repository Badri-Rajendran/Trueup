          ...
          <div className="tu-message-list__suggestions">
            {SUGGESTED_QUESTIONS.map((question) => (
              <button
                key={question}
                type="button"
                className="tu-message-list__suggestion"
  ...
  return (
    <div className="tu-message-list">
      {messages.map((message) => (
        ...
        >
          <div className="tu-message-list__text">
      ...
      {isStreaming && (
        <div className="tu-message-list__bubble tu-message-list__bubble--assistant">
          {streamingText ? (
            ...
            <span className="tu-message-list__typing" aria-label="Assistant is working on a reply">
              <span />
              <span />
              <span />
            </span>
